## Beispiel der Plantuml Diagramerstellung

Plantuml Diagramme sind reine textbasierte Diagramme welche über das Framework plantuml in Grafikformate gewandelt
...
Da die Bereiche in einer festgelegten Reihenfolge in der Diagrambeschreibung aufgeführt werden müssen, eignet sollten
...
werden wir auch in diesemm Beispiel statt eines Strings einen StringBuilder als zu buildende Instanz verwenden.
...
----
include::../../test/java/com/github/huluvu424242/e4plantumldiagram/PlantumlEntityDiagramBuilderTest.java[lines=28..-1]
----
